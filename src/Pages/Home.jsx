  ...
  return (
    <section>
      ...
      <form onSubmit = {signUp} className="flex flex-col justify-center items-center">
        <input name="Nom" type="text" className='border-[1px] m-2 h-8 w-70 rounded p-2' placeholder='Écriver votre username'/>
        <input name="Email" type="email" className='border-[1px] m-2 h-8 w-70 rounded p-2' placeholder='Écriver votre email'/>
